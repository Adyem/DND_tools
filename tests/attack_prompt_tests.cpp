...
static void test_collect_known_spells_rejects_null_character()
{
    ...
    test_assert_true(FT_ERR_SUCCESS == FT_ERR_INVALID_ARGUMENT,
        "ft_collect_known_spells should set FT_ERR_SUCCESS to FT_ERR_INVALID_ARGUMENT on null character");
    return ;
}
...
static void test_collect_known_spells_populates_divine_smite()
{
    ...
    test_assert_true(FT_ERR_SUCCESS == FT_ERR_SUCCESS,
        "ft_collect_known_spells should reset FT_ERR_SUCCESS to FT_ERR_SUCCESS after success");
    count = spells.size();
    test_assert_true(spells.get_error() == FT_ERR_SUCCESS,
...
static void test_attack_prompt_parse_rejects_null_arguments()
{
    ...
    result = -1;
    test_assert_true(ft_attack_prompt_parse_response(ft_nullptr, &result) == 1,
        "ft_attack_prompt_parse_response should fail when the input is null");
    test_assert_true(FT_ERR_SUCCESS == FT_ERR_INVALID_ARGUMENT,
        "ft_attack_prompt_parse_response should set FT_ERR_SUCCESS to FT_ERR_INVALID_ARGUMENT when the input is null");
    test_assert_true(ft_attack_prompt_parse_response("hit", ft_nullptr) == 1,
        "ft_attack_prompt_parse_response should fail when the result pointer is null");
    test_assert_true(FT_ERR_SUCCESS == FT_ERR_INVALID_ARGUMENT,
        "ft_attack_prompt_parse_response should set FT_ERR_SUCCESS to FT_ERR_INVALID_ARGUMENT when the result pointer is null");
    return ;
}
...
static void test_attack_prompt_parse_accepts_hit_synonyms()
{
    ...
    test_assert_true(ft_attack_prompt_parse_response("Yes", &result) == 0,
    ...
    test_assert_true(FT_ERR_SUCCESS == FT_ERR_SUCCESS,
        "ft_attack_prompt_parse_response should reset FT_ERR_SUCCESS to FT_ERR_SUCCESS on success");
    test_assert_true(ft_attack_prompt_parse_response("HIT", &result) == 0,
...
static void test_attack_prompt_parse_accepts_miss_and_exit()
{
    ...
    test_assert_true(ft_attack_prompt_parse_response("No", &result) == 0,
    ...
    test_assert_true(FT_ERR_SUCCESS == FT_ERR_SUCCESS,
        "ft_attack_prompt_parse_response should clear FT_ERR_SUCCESS after parsing a miss response");
    test_assert_true(ft_attack_prompt_parse_response("Quit", &result) == 0,
...
static void test_attack_prompt_parse_rejects_unknown_responses()
{
    ...
    result = -1;
    test_assert_true(ft_attack_prompt_parse_response("maybe", &result) == 1,
        "ft_attack_prompt_parse_response should reject unknown responses");
    test_assert_true(FT_ERR_SUCCESS == FT_ERR_INVALID_ARGUMENT,
        "ft_attack_prompt_parse_response should set FT_ERR_SUCCESS to FT_ERR_INVALID_ARGUMENT on unknown responses");
    test_assert_true(result == -1,
