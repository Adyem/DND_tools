...
static void test_command_roll_handles_parentheses_and_unary_minus()
{
    ...
    test_assert_true(FT_ERR_SUCCESS == FT_ERR_SUCCESS, "ft_command_roll should set errno to success for complex expressions");
...
static void test_command_roll_handles_multiple_dice_segments()
{
    ...
    test_assert_true(FT_ERR_SUCCESS == FT_ERR_SUCCESS, "ft_command_roll should set errno to success for multiple dice segments");
    if (result != ft_nullptr)
    {
...
static void test_command_roll_rejects_uppercase_dice_identifier()
{
    ...
    test_assert_true(FT_ERR_SUCCESS == FT_ERR_INVALID_ARGUMENT, "ft_command_roll should set errno to FT_ERR_INVALID_ARGUMENT for uppercase dice identifiers");
...
static void test_command_roll_handles_leading_unary_minus_and_multiplication()
{
    ...
    test_assert_true(FT_ERR_SUCCESS == FT_ERR_SUCCESS, "ft_command_roll should set errno to success for subtraction expressions");
    if (result != ft_nullptr)
    {
...
static void test_command_roll_supports_nested_parentheses_and_division()
{
    ...
    test_assert_true(FT_ERR_SUCCESS == FT_ERR_SUCCESS, "ft_command_roll should set errno to success for nested parentheses expressions");
    if (result != ft_nullptr)
    {
...
static void test_command_roll_evaluates_operator_precedence()
{
    ...
    test_assert_true(FT_ERR_SUCCESS == FT_ERR_SUCCESS, "ft_command_roll should set errno to success for precedence expressions");
    if (result != ft_nullptr)
    {
...
static void test_command_roll_handles_nested_negative_results()
{
    ...
    test_assert_true(FT_ERR_SUCCESS == FT_ERR_SUCCESS, "ft_command_roll should set errno to success for nested negative expressions");
    if (result != ft_nullptr)
    {
...
static void test_command_roll_evaluates_deeply_nested_mixed_operations()
{
    ...
    test_assert_true(FT_ERR_SUCCESS == FT_ERR_SUCCESS, "ft_command_roll should set errno to success for deeply nested expressions");
    if (result != ft_nullptr)
    {
...
static void test_command_roll_supports_leading_unary_parentheses_groups()
{
    ...
    test_assert_true(FT_ERR_SUCCESS == FT_ERR_SUCCESS, "ft_command_roll should set errno to success for leading unary parentheses groups");
    if (result != ft_nullptr)
    {
...
static void test_command_roll_evaluates_large_dice_counts_and_mixed_groups()
{
    ...
    test_assert_true(FT_ERR_SUCCESS == FT_ERR_SUCCESS, "ft_command_roll should set errno to success for large dice quantity expressions");
    if (result != ft_nullptr)
    {
