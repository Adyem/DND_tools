...
static const    t_attack HILDA_STORMSHIELD_ATTACK =
{
    .attack_bonus = 2,
    .ranged_bonus = 0,
};

static const    t_crit_mod HILDA_STORMSHIELD_CRIT =
{
    .attack = 0,
    .attack_d = 0,
    .save = 0,
...
static const    t_resistance HILDA_STORMSHIELD_DEFAULT_RESISTANCE =
{
    .acid = 0,
    .bludgeoning = 0,
    .cold = 0,
...
static const    t_equipment HILDA_STORMSHIELD_EQUIPMENT =
{
...
static const    t_physical HILDA_STORMSHIELD_PHYSICAL =
{
    .height = 48,
    .weight = 150,
    .age = 100,
