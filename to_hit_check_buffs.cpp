...
static void ft_to_hit_check_buff_chaos_armor()
{
	...
	else if (effect_roll == 2)
	{
		...
		pf_printf("Chaos Armor activates: The attacker takes %d ice damage and is slowed, halving his/her movement!\n", damage_roll);
	}
	...
	else if (effect_roll == 4)
	{
		...
		pf_printf("Chaos Armor activates: The attacker takes %d poison damage and is poisoned, he/she now has disadvantage on attack rolls and ability checks\n", damage_roll);
	}
