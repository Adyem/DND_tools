...
void ft_update_lightningV2_strike(t_char * info)
{
    ...
    if (info->bufs.lightning_strikeV2.duration == 0)
    {
        ...
        pf_printf("%s unleashes a lightning strike, dealing %d lightning damage "
        ...
        pf_printf("%s is preparing a lightning strike that will unleash on the next turn.\n",
                  info->name);
    else
        pf_printf("%s's lightning strike will unleash in %d turns.\n",
