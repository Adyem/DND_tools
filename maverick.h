...
static const	t_stats MAVERICK_STATS =
{
	.phase = -1,
	.turn = -1,
	.health = -1,
...
static const	t_f_attack MAVERICK_F_ATTACK =
{
	.attack = ft_maverick_attack,
	.ranged_attack = NULL,
};

static const	t_bless MAVERICK_BLESS =
{
	.duration = 0,
};

static const	t_protective_winds MAVERICK_PROTECTIVE_WINDS =
{
	.duration = 0,
};

static const	t_lightning_strike MAVERICK_LIGHTNING_STRIKE =
{
	.duration = 0,
	.amount = 0,
	.distance = 0,
...
static const	t_air_totem MAVERICK_AIR_TOTEM =
{
...
static const	t_bufs MAVERICK_BUFFS =
{
	.bless = MAVERICK_BLESS,
	.protective_winds = MAVERICK_PROTECTIVE_WINDS,
	.lightning_strike = MAVERICK_LIGHTNING_STRIKE,
};

static const	t_debufs MAVERICK_DEBUFFS =
{
};
