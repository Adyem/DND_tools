...
static const	t_stats FELBEAST_DEFAULT_STATS =
{
	.phase = 0,
	.turn = 1,
	.health = 50,
...
static const	t_save FELBEAST_SAVE_MODS =
{
    .str = 1,
    .dex = 3,
	.inte = 0,
...
static const	t_skills FELBEAST_SKILL_MODS =
{
    .athletics = 2,
    .acrobatics = 2,
    .sleight_of_hand = 3,
...
static const	t_attack FELBEAST_ATTACK =
{
	.attack_bonus = 0,
	.ranged_bonus = 0,
};
...
static const	t_crit_mod FELBEAST_CRIT =
{
	.attack = 0,
	.attack_d = 0,
	.save = 0,
...
static const	t_resistance FELBEAST_DEFAULT_RESISTANCE =
{
	.acid = 0,
	.bludgeoning = 0,
	.cold = 0,
...
static const	t_equipment FELBEAST_EQUIPMENT =
{
	.weapon = STEEL_SWORD,
...
static const t_physical FELBEAST_PHYSICAL =
{
    .height = 0,
    .weight = 0,
    .age = 0,
...
static const t_spell_slot FELBEAST_SPELL_SLOT =
{
	.available = 0,
	.total = 0,
	.level = 0,
...
static const t_spell_slots FELBEAST_SPELL_SLOTS =
{
...
static const t_inventory FELBEAST_INVENTORY
{
	.gold = 0,
};
