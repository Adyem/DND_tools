...
#define KEY_LIST \
	...
	X(BUFF_MAGIC_DRAIN_DAMAGE_FLAT_KEY, "BUFF_MAGIC_DRAIN_DAMAGE_FLAT=") \
	X(BUFF_MAGIC_DRAIN_SPELL_SLOT_TOTAL_LEVEL_DRAIN_KEY, \
			"BUFF_MAGIC_DRAIN_SPELL_SLOT_TOTAL_LEVEL_DRAIN=") \
	X(BUFF_MAGIC_DRAIN_DICE_AMOUNT_KEY, "BUFF_MAGIC_DRAIN_DICE_AMOUNT=") \
	X(BUFF_MAGIC_DRAIN_DICE_FACES_KEY, "BUFF_MAGIC_DRAIN_DICE_FACES=")
