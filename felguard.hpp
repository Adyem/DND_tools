...
static const	t_stats FELGUARD_DEFAULT_STATS =
{
	.phase = 0,
	.turn = 1,
	.health = 50,
...
static const	t_save FELGUARD_SAVE_MODS =
{
    .str = 1,
    .dex = 3,
	.inte = 0,
...
static const	t_attack FELGUARD_ATTACK =
{
	.attack_bonus = 0,
	.ranged_bonus = 0,
};
...
static const	t_crit_mod FELGUARD_CRIT =
{
	.attack = 0,
	.attack_d = 0,
	.save = 0,
...
static const	t_resistance FELGUARD_DEFAULT_RESISTANCE =
{
	.acid = 0,
	.bludgeoning = 0,
	.cold = 0,
...
static const t_physical FELGUARD_PHYSICAL =
{
    .height = 0,
    .weight = 0,
    .age = 0,
...
static const t_spell_slot FELGUARD_SPELL_SLOT =
{
	.available = 0,
	.total = 0,
	.level = 0,
...
static const t_spell_slots FELGUARD_SPELL_SLOTS =
{
...
static const t_inventory FELGUARD_INVENTORY
{
	.gold = 0,
};
...
inline ValidateHitDice<FELGUARD_HIT_DICE.dice_amount,
	   					FELGUARD_HIT_DICE.dice_faces> validation_instance;
