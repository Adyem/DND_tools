...
static void	ft_veraak_phase_second(ft_sharedptr<t_char> &info)
{
...
static void	ft_veraak_phase_third(ft_sharedptr<t_char> &info)
{
	if (info->stats.turn == 1)
...
static void	ft_veraak_phase_four(ft_sharedptr<t_char> &info)
{
	if (info->stats.turn == 1)
...
static void	ft_veraak_phase_five(ft_sharedptr<t_char> &info)
{
	if (info->stats.turn == 1)
		ft_cast_chaos_armor(info);
