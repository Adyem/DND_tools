...
{
    ft_printf("Lightning Strike: The boss's skin will flare with electricity at " \
...
{
    ft_printf("Lightning Strike V2: A marker appears at a random location, " \
			"indicating where lightning will strike.\n");
    ft_printf("At the start of the boss's next turn, it deals %d lightning " \
    ...
    ft_printf("(Be careful with placement on Lightning Strike V2 so it isn’t " \
