...
static void	ft_maverick_lightning_strike(ft_sharedptr<t_char> &info)
{
...
static void	ft_maverick_lightningV2_strike(ft_sharedptr<t_char> &info)
{
...
static void	ft_maverick_flame_geyser(ft_sharedptr<t_char> &info)
{
...
static void ft_maverick_meteor_strike(ft_sharedptr<t_char> &info, char **player_list)
{
...
static void	ft_maverick_earth_pounce(ft_sharedptr<t_char> &info, char **player_list)
{
...
static void	ft_maverick_arcane_pounce(ft_sharedptr<t_char> &info, char **player_list)
{
...
static void	ft_maverick_frost_breath(ft_sharedptr<t_char> &info, char **player_list)
{
	cma_free(info->bufs.frost_breath.target_id);
	info->bufs.frost_breath.target_id = ft_nullptr;
...
void ft_maverick_print_f(int first, int second, ft_sharedptr<t_char> &info, char **player_list)
{
    if (first == 1)
...
void ft_maverick_print_s(int first, int second, ft_sharedptr<t_char> &info, char **player_list)
{
    if (second == 1)
